...
<main class="pt-4">
    ...
    <section style="background-image: url(https://mdbootstrap.com/img/Photos/Others/gradient1.jpg);">
        ...
        <div class="text-white text-center py-5 px-5 my-5">
            ...
            <h4>
                Now , doctor booking and order medicines is made simple with medspace
            </h4>
            <!--Card: Jumbotron-->
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mx-auto mt-3 mb-5">
                    <div class="row">
                        <div class="col-md-4">
                            <h1 class="">30</h1>
                            <h5 class="font-weight-bold">Hospital's</h5>
                        </div>
                        <div class="col-md-4">
                            <h1 class="">30</h1>
                            <h5 class="font-weight-bold">Clinic's</h5>
                        </div>
                        <div class="col-md-4">
                            <h1 class="">30</h1>
                            <h5 class="font-weight-bold">Doctor's</h5>
                        </div>
                    </div>
            ...
            <div class="col-md-4 mb-4 mr-auto">
                ...
                <div class="card mdb-color blue-grey lighten-3 mb-4 wow fadeIn">
                    ...
                    <div class="card-body text-center text-white">
                        ...
                        <a class="btn btn-outline-black"><i class="fa fa-user-plus left"></i> Register </a>
                    </div>
                    <!-- Content -->
                </div>
                <!--Card: Jumbotron-->
